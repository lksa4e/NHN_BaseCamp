...
import ogr.zerock.guestbook.repository.GuestbookRepository;
...
@Service
@Log4j2
@RequiredArgsConstructor   // repository 의존성 자동 주입
public class GuestbookServiceImpl implements GuestbookService{
    ...
    public GuestbookDTO read(Long gno) {
        ...
        // findById()를 통해서 엔티티 객체를 가져왔다면 entityToDto 를 통해서 DTO로 변환해서 반환
